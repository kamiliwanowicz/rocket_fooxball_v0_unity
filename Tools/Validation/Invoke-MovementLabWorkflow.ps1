...
$script:AppendixAPaths = @(
    ...
    'Assets/_Game/Materials/ShotgunPellet.mat', 'Assets/_Game/Materials/ShotgunPellet.mat.meta', 'Assets/_Game/Materials/WeaponImpactMark.mat', 'Assets/_Game/Materials/WeaponImpactMark.mat.meta',
    # generated pairs
