...
namespace RocketFooxball.Editor
{
    internal static partial class MovementLabSceneComposer
    {
                ...
                internal static void AssembleGameplaySceneStage()
                {
                    ...
                    var northShieldMaterial = LoadRequiredAsset<Material>(MaterialsPath + "/ShieldRed.mat");
                    var southShieldMaterial = LoadRequiredAsset<Material>(MaterialsPath + "/ShieldBlue.mat");
                    ...
                    try
                    {
                        ...
                        var arena = BuildArena(floorMaterial, wallMaterial, markingMaterial, frameMaterial, shieldMaterial, ballSurface, arenaPrimaryMaterial, arenaTrimMaterial, arenaHazardMaterial, arenaGlowMaterial, northShieldMaterial, southShieldMaterial, teamBlueMaterial, teamRedMaterial);
