...
namespace RocketFooxball.Editor
{
    internal static partial class MovementLabLightingPipeline
    {
                ...
                internal static void BakeSceneLighting(Scene scene, string passPath, MovementLabLightingProfiles.ProfileId profile)
                {
                    ...
                    {
                        // Material purity is checked for both successful and
                        // failed bake attempts. No repair/setter/save path is
                        // reachable from this boundary.
                        try
                        {
                            AssertGeneratedMaterialHashesUnchanged(materialHashes);
                        }
                        finally
                        {
                            AssertGeneratedMaterialDirtyStateUnchanged(materialDirty);
                        }
                    }
